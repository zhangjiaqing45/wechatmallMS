package com.fante.framework.web.controller;
...
import com.fante.framework.web.domain.AjaxResult.Type;
...
public class BaseController {
    ...
    public String getToken() {
        return ServletUtils.getRequest().getHeader(jwtHeader);
    }
    ...
    public String getTokenClientId() {
        return jwtUtils.getClientIdByToken(getToken());
    }
