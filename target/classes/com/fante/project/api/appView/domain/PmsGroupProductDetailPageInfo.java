 ...
 * @CreatTime 2020/3/14
 */
public class PmsGroupProductDetailPageInfo extends SmsGroupGame implements IDetailPageInfo{
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "sku集合")
    private List<SmsGroupGameSku> skuList;
    ...
    public List<SmsGroupGameSku> getSkuList() {
        return skuList;
    }

    public void setSkuList(List<SmsGroupGameSku> skuList) {
