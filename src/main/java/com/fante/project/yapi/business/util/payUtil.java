package com.fante.project.yapi.business.util;
...
//            }
    ...
    public static String signMap(Map<String, String> plainMap, String signKey) {
        ...
        log.info("签名原串 plainStr:{}", bf.toString());
        log.info("签名原串_getBytes:{}", bf.toString() .getBytes());
        return DigestUtils.md5Hex(bf.toString());
    }
