...
public class UserController extends BaseController {
    ...
    public TableDataInfo list(User user) {
        user.setUserType(UserTypeEnum.SYSTEM.getType());
        startPage();
    ...
    public String add(ModelMap mmap) {
        ...
        Role role = new Role();
        role.setRoleType(UserTypeEnum.SYSTEM.getType());
    ...
    public String edit(@PathVariable("userId") Long userId, ModelMap mmap) {
        ...
        mmap.put("roles" , roleService.selectRolesByUserId(userId, UserTypeEnum.SYSTEM.getType()));
