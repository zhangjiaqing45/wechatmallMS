package com.fante.project.tool.gen.util;

import com.alibaba.fastjson.JSONObject;
import com.fante.common.constant.GenConstants;
import com.fante.common.utils.DateUtils;
import com.fante.common.utils.StringUtils;
import com.fante.project.tool.gen.domain.GenTable;
import com.fante.project.tool.gen.domain.GenTableColumn;
...
public class VelocityUtils {
    ...
    public static List<String> getTemplateList(String tplCategory) {
        ...
        templates.add("vm/java/mapperBase.java.vm");
        templates.add("vm/java/mapper.java.vm");
        templates.add("vm/java/service.java.vm");
        templates.add("vm/java/serviceImpl.java.vm");
        templates.add("vm/java/controller.java.vm");
        templates.add("vm/xml/mapper.xml.vm");
        templates.add("vm/xml/mapperBase.xml.vm");
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        } else if (template.contains("mapperBase.java.vm")) {
            fileName = StringUtils.format("{}/mapperBase/{}MapperBase.java" , javaPath.replace("/business",""), className);
        ...
        } else if (template.contains("mapperBase.xml.vm")) {
            fileName = StringUtils.format("{}/mapperBase/{}MapperBase.xml" , mybatisPath.replace("/business",""),className);
