 ...
 */
@Component
public class TestDeadLetterReceiver {

    private static Logger log = LoggerFactory.getLogger(TestDeadLetterReceiver.class);

    private static final String QUEUE_INFO = "测试死信队列";
     ...
     * @param msg 接收到的消息
     */
    @RabbitListener(queues = "#{testDeadLetterQueue.name}", containerFactory = "singleListenerContainer")
